...
def multiply_list(lst):
    ...
    0
    """
    #base case is what needs to be ture for me to start the chain reaction of getting out of the inner functions.
    if lst == []:
        return 0
        ...
        return lst.pop(0) * multiply_list(lst)
